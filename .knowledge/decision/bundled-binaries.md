...
summary:
  ...
  first_release: 0.1.1 on 2026-09-13 to all registries (Maven via workflow_dispatch re-publish after a signing fix)
  republish: gh workflow run release.yml -f version=X.Y.Z -f registries=maven (subset of npm,pypi,maven)
