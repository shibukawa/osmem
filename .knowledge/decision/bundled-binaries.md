...
summary:
  ...
  packaging:
    ...
    maven: groupId dev.osmem (needs DNS verification of osmem.dev; io.github.shibukawa is the fallback), artifacts osmem + osmem-server-binaries with os-arch classifier jars; multi-module pom with release profile (sources, javadoc, gpg, central-publishing-maven-plugin 0.11.0)
